...
/// 勘定科目構成マスタの作成
/// </summary>
[Migration(20250121006)]
public class Migration_20250121_006_CreateAccountStructure : Migration
{
    public override void Up()
    {
        ...
        // 外部キー制約
        Create.ForeignKey("fk_account_structure_account")
