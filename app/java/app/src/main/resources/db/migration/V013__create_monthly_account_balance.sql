...
COMMENT ON COLUMN "月次勘定科目残高"."勘定科目コード" IS '勘定科目マスタの外部キー';
COMMENT ON COLUMN "月次勘定科目残高"."補助科目コード" IS '補助科目（得意先、仕入先など）';
COMMENT ON COLUMN "月次勘定科目残高"."部門コード" IS '部門別管理用';
COMMENT ON COLUMN "月次勘定科目残高"."プロジェクトコード" IS 'プロジェクト別管理用';
COMMENT ON COLUMN "月次勘定科目残高"."決算仕訳フラグ" IS '0=通常仕訳、1=決算仕訳';
COMMENT ON COLUMN "月次勘定科目残高"."月初残高" IS '月初時点の残高';
COMMENT ON COLUMN "月次勘定科目残高"."借方金額" IS '月間借方合計金額';
COMMENT ON COLUMN "月次勘定科目残高"."貸方金額" IS '月間貸方合計金額';
