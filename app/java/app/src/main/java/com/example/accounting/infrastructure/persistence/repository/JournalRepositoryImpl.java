...
public class JournalRepositoryImpl implements JournalRepository {
    ...
    public Optional<Journal> findByJournalNo(String journalNo) {
        com.example.accounting.infrastructure.persistence.entity.Journal entity =
    ...
    public Journal save(Journal journal) {
        com.example.accounting.infrastructure.persistence.entity.Journal existingEntity =
        ...
        // ヘッダー登録
        com.example.accounting.infrastructure.persistence.entity.Journal entity = toEntity(journal);
     ...
     */
    private Journal toDomainModel(com.example.accounting.infrastructure.persistence.entity.Journal entity) {
        if (entity == null) {
            return null;
        }
     ...
     */
    private com.example.accounting.infrastructure.persistence.entity.Journal toEntity(Journal domain) {
        com.example.accounting.infrastructure.persistence.entity.Journal entity =
                new com.example.accounting.infrastructure.persistence.entity.Journal();
