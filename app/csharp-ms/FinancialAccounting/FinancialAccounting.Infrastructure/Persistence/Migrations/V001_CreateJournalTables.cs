...
/// </summary>
[Migration(1)]
public class V001_CreateJournalTables : Migration
{
    public override void Up()
    {
        ...
        Create.Index("idx_journals_fiscal_year").OnTable("journals").OnColumn("fiscal_year");
        Create.Index("idx_journals_journal_date").OnTable("journals").OnColumn("journal_date");
        ...
        Create.ForeignKey("fk_journal_entries_journals")
            .FromTable("journal_entries").ForeignColumn("journal_id")
            .ToTable("journals").PrimaryColumn("journal_id")
            .OnDelete(System.Data.Rule.Cascade);

        Create.Index("idx_journal_entries_journal_id").OnTable("journal_entries").OnColumn("journal_id");
        Create.Index("idx_journal_entries_account_code").OnTable("journal_entries").OnColumn("account_code");
    }

    public override void Down()
    {
        Delete.Table("journal_entries");
        Delete.Table("journals");
