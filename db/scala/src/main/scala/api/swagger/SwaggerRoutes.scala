              ...
              "content"     -> Json.obj(
                "application/json" -> Json.obj(
                  "schema" -> Json.obj(
                    ...
                    "items" -> Json.obj(
                      "$ref" -> Json.fromString("#/components/schemas/ProductResponse")
                    ),
                  )
                )
              ),
        ...
        "post" -> Json.obj(
          ...
          "requestBody" -> Json.obj(
            ...
            "content"  -> Json.obj(
              "application/json" -> Json.obj(
                "schema" -> Json.obj(
                  "$ref" -> Json.fromString("#/components/schemas/CreateProductRequest")
                )
              )
            ),
          ),
          "responses"   -> Json.obj(
            ...
            "400" -> Json.obj(
              ...
              "content"     -> Json.obj(
                "application/json" -> Json.obj(
                  "schema" -> Json.obj(
                    "$ref" -> Json.fromString("#/components/schemas/ErrorResponse")
                  )
                )
              ),
            ),
        ...
        "put"    -> Json.obj(
          ...
          "requestBody" -> Json.obj(
            ...
            "content"  -> Json.obj(
              "application/json" -> Json.obj(
                "schema" -> Json.obj(
                  "$ref" -> Json.fromString("#/components/schemas/UpdateProductRequest")
                )
              )
            ),
          ),
    ...
    "components" -> Json.obj(
      "schemas" -> Json.obj(
        "ProductResponse"      -> Json.obj(
          ...
          "properties" -> Json.obj(
            "prodCode"     -> Json
              .obj("type" -> Json.fromString("string"), "description" -> Json.fromString("商品コード")),
            "fullName"     -> Json
              .obj("type" -> Json.fromString("string"), "description" -> Json.fromString("商品正式名")),
            "name"         -> Json
              .obj("type" -> Json.fromString("string"), "description" -> Json.fromString("商品略称")),
            "kana"         -> Json.obj(
              "type"        -> Json.fromString("string"),
              "nullable"    -> Json.fromBoolean(true),
              "description" -> Json.fromString("商品名カナ"),
            ),
            "unitPrice"    -> Json
              .obj("type" -> Json.fromString("integer"), "description" -> Json.fromString("販売単価")),
            "poPrice"      -> Json
              .obj("type" -> Json.fromString("integer"), "description" -> Json.fromString("仕入単価")),
            "supCode"      -> Json
              .obj("type" -> Json.fromString("string"), "description" -> Json.fromString("仕入先コード")),
            "categoryCode" -> Json.obj(
              "type"        -> Json.fromString("string"),
              "nullable"    -> Json.fromBoolean(true),
              "description" -> Json.fromString("商品分類コード"),
            ),
          ),
        ),
        ...
        "ErrorResponse"        -> Json.obj(
          ...
          "properties" -> Json.obj(
            "error"   -> Json.obj(
              "type"        -> Json.fromString("string"),
              "description" -> Json.fromString("エラーメッセージ"),
            ),
            "details" -> Json.obj(
              "type"        -> Json.fromString("string"),
              "nullable"    -> Json.fromBoolean(true),
              "description" -> Json.fromString("エラー詳細"),
            ),
          ),
        ),
      )
