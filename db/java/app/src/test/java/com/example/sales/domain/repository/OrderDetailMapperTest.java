...
/**
 * 受注データ明細Mapperのテストクラス
 */
class OrderDetailMapperTest extends AbstractDatabaseTest {
    ...
    void testInsertAndFindById() {
        ...
        detail.setOrderNo("O000000001");
        detail.setOrderRowNo(1);
        detail.setProductCode("PROD001");
        detail.setProductName("ノートパソコン A型");
        detail.setUnitPrice(150000);
        detail.setQuantity(2);
        detail.setConsumptionTaxRate(10);
        detail.setReserveQuantity(0);
        detail.setDeliveryOrderQuantity(0);
        detail.setDeliveredQuantity(0);
        detail.setCompleteFlag(0);
        detail.setDiscount(0);
        detail.setCreatedBy("tester");
        detail.setUpdatedBy("tester");

        // 挿入
        int result = orderDetailMapper.insert(detail);
        assertThat(result).isEqualTo(1);

        // 取得
        Optional<OrderDetail> found = orderDetailMapper.findById("O000000001", 1);
        assertThat(found).isPresent();
        assertThat(found.get().getOrderNo()).isEqualTo("O000000001");
        assertThat(found.get().getOrderRowNo()).isEqualTo(1);
    ...
    void testUpdate() {
        ...
        int result = orderDetailMapper.update(detail);
        assertThat(result).isEqualTo(1);
    ...
    void testDelete() {
        ...
        // 削除
        int result = orderDetailMapper.delete("O000000001", 1);
        assertThat(result).isEqualTo(1);
    ...
    void testFindByOrderNo() {
        ...
        detail1.setOrderNo("O000000001");
        detail1.setOrderRowNo(1);
        detail1.setProductCode("PROD001");
        detail1.setProductName("ノートパソコン A型");
        detail1.setUnitPrice(150000);
        detail1.setQuantity(2);
        detail1.setConsumptionTaxRate(10);
        detail1.setCreatedBy("tester");
        detail1.setUpdatedBy("tester");
        orderDetailMapper.insert(detail1);

        // 受注明細2を作成
        OrderDetail detail2 = new OrderDetail();
        detail2.setOrderNo("O000000001");
        detail2.setOrderRowNo(2);
        detail2.setProductCode("PROD001");
        detail2.setProductName("ノートパソコン A型");
        detail2.setUnitPrice(150000);
        detail2.setQuantity(1);
        detail2.setConsumptionTaxRate(10);
        detail2.setCreatedBy("tester");
        detail2.setUpdatedBy("tester");
        orderDetailMapper.insert(detail2);

        // 受注番号で検索
        List<OrderDetail> details = orderDetailMapper.findByOrderNo("O000000001");
        assertThat(details).hasSize(2);
        assertThat(details.get(0).getOrderRowNo()).isEqualTo(1);
        assertThat(details.get(1).getOrderRowNo()).isEqualTo(2);
    }
    ...
    void testFindByProductCode() {
        ...
        // 商品コードで検索
        List<OrderDetail> details = orderDetailMapper.findByProductCode("PROD001");
        assertThat(details).hasSize(1);
        assertThat(details.get(0).getOrderNo()).isEqualTo("O000000001");
    }
    ...
    void testFindAll() {
        ...
        // 全件取得
        List<OrderDetail> details = orderDetailMapper.findAll();
        assertThat(details).hasSize(1);
    }
}
