...
namespace SalesManagement.Infrastructure.Migrations
{
    ...
    /// 顧客別販売単価テーブルの作成
    /// </summary>
    [Migration(20250106006)]
    public class Migration20250106006CreatePriceByCustomerTable : Migration
    {
        public override void Up()
        {
            ...
            Create.PrimaryKey("pk_顧客別販売単価")
                .OnTable("顧客別販売単価")
                .Columns("商品コード", "取引先コード");

            Create.Index("idx_顧客別販売単価_取引先コード")
                .OnTable("顧客別販売単価")
                .OnColumn("取引先コード");

            Create.ForeignKey("fk_顧客別販売単価_商品コード")
