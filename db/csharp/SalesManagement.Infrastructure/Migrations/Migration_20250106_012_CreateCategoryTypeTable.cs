...
namespace SalesManagement.Infrastructure.Migrations
{
    ...
    public class Migration20250106012CreateCategoryTypeTable : Migration
    {
        public override void Up()
        {
            ...
            IfDatabase("Postgres").Execute.Sql("COMMENT ON TABLE 分類種別マスタ IS '取引先を分類する軸を定義するマスタ'");
            IfDatabase("Postgres").Execute.Sql("COMMENT ON COLUMN 分類種別マスタ.分類種別 IS '業種、規模、地域など分類の種類'");
        }
