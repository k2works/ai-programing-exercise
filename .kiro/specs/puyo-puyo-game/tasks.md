...
- [ ] 3. フィールド管理システムの作成
  - [ ] 3.1 12x6グリッド操作のためのFieldManagerクラスの実装
    - プレイフィールドの2D配列表現を作成
