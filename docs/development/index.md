...
| [イテレーション 5 計画](./iteration_plan-5.md) | 視覚アセット + 体験フロー（v0.5.0）。US-401 / US-402 / US-403 / 7 SP / 5.3 理想時間 ✅ ローカル完了 / runClient 検証待ち |
| [イテレーション 5 ふりかえり](./retrospective-5.md) | KPT + `developing-review` 5 観点バッチ結果統合 |
| [イテレーション 6 計画 ★ MVP](./iteration_plan-6.md) | ワールドジェン統合 = プレイ可能 MVP（v1.0.0）。US-501 / US-502 / 8 SP / 11.9 理想時間（IT-5 Try 反映タスク追加で 12.5 理想時間） |
...
| IT-5 | 2026-05-02（ローカル準備完了）| 7 | 🟡 7/7 SP 実装完了 / runClient 検証待ち |
| **IT-6 ★ MVP** | 2026-07-13 〜 07-26 | 8 | 📋 計画作成済 |
