...
| [イテレーション 4 計画](./iteration_plan-4.md) | ワールドジェン（v0.4.0）。US-301 / US-302 / 13 SP / 15.1 理想時間 |
...
| `iteration_report-{1,2,3}.md` | 各 IT の完了報告書 | 任意（簡易版でリリース完了報告に統合可）|
| `release_report-v{0.1.0,0.2.0,0.3.0}.md` | リリース完了報告書 | 任意 |
...
| IT-4 | 2026-06-15 〜 06-28 | 13 | 📋 計画作成済 |
