...
| [イテレーション 5 計画](./iteration_plan-5.md) | 視覚アセット + 体験フロー（v0.5.0）。US-401 / US-402 / US-403 / 7 SP / 5.3 理想時間 |
| [イテレーション 6 計画 ★ MVP](./iteration_plan-6.md) | ワールドジェン統合 = プレイ可能 MVP（v1.0.0）。US-501 / US-502 / 8 SP / 11.9 理想時間 |
