...
| [イテレーション 3 計画](./iteration_plan-3.md) | アイテム / クラフト（v0.3.0）。US-201 / US-202 / 8 SP / 10.3 理想時間 |
...
| `iteration_report-{1,2}.md` | 各 IT の完了報告書 | 任意（簡易版でリリース完了報告に統合可）|
| `release_report-v{0.1.0,0.2.0}.md` | リリース完了報告書 | 任意 |
