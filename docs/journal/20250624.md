...
```
docs: add Copilot instructions for TDD best practices
```
...
```diff
commit aa9221fea35fa8359bee7b0a400ce65e954a9a2a
Author: k2works <kakimomokuri@gmail.com>
Date:   Tue Jun 24 18:55:27 2025 +0900

    docs: add Copilot instructions for TDD best practices

diff --git a/.github/copilot-instructions.md b/.github/copilot-instructions.md
new file mode 100644
index 0000000..8e78b05
--- /dev/null
