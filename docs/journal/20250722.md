...
```
feat: implement game initialization and loop start
```
...
```diff
commit f30768707a1febf4e1bd63406b9ec250b71ad899
Author: k2works <kakimomokuri@gmail.com>
Date:   Tue Jul 22 07:11:59 2025 +0000

    feat: implement game initialization and loop start

diff --git a/app/src/game.ts b/app/src/game.ts
index 7906579..b6e187b 100644
--- a/app/src/game.ts
+++ b/app/src/game.ts
...
```
feat: puyopuyo application setup in app/
```
...
```diff
commit faa3111ef8f4d8c7162777ecd6f4be29d2447c6b
Author: k2works <kakimomokuri@gmail.com>
Date:   Tue Jul 22 06:57:10 2025 +0000
...
+    <div
+      id="stage"
+      style="position: relative; margin: 0 auto; overflow: hidden; background: #f0f0f0"
+    ></div>
+    <div
+      id="score"
